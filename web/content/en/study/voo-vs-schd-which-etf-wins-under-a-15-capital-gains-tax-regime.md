---
title: "VOO vs SCHD: Which ETF Wins Under a 15% Capital-Gains Tax Regime?"
date: 2026-06-20
lastmod: 2026-06-20
draft: false
description: "VOO vs SCHD under 15% capital-gains tax: +26.8% return vs 3.25% yield. How dividend drag impacts 20-year taxable accounts."
keywords: "조세, VOO vs SCHD comparison, dividend yield taxation, capital gains tax impact, tax-efficient ETF investing, dividend growth ETF vs broad market"
primary_keyword: "조세"
...
data_fetched_at: "2026-06-19T22:06:55Z"
...
seo_audit:
  ...
  hard_violations: []
  soft_violations:
    - "title 길이 65자 (30-60 권장)"
    - "키워드 밀도 0.00% (0.5%+ 권장)"
    - "primary_keyword 첫 단락 미포함"
    - "primary_keyword 마지막 단락 미포함"
    - "[downgraded] primary_keyword '조세' title에 미포함"
cover:
    image: "/images/voo-vs-schd-which-etf-wins-under-a-15-capital-gains-tax-regime/compound-growth.png"
    alt: "VOO vs SCHD: Which ETF Wins Under a 15% Capital-Gains Tax Regime?"
    relative: false
tags:
  - "VOO"
  - "SCHD"
...
<div class="summary-box">
  <ul>
    ...
    <li>VOO's P/E of 26.9 vs SCHD's 18.8 signals growth premium; contrarian case favors SCHD if rates compress</li>
  </ul>
...
<figure class="chart-figure"><img src="/images/voo-vs-schd-which-etf-wins-under-a-15-capital-gains-tax-regime/compound-growth.png" alt="Monthly $30K investment 20-year compound growth simulation" loading="lazy" style="max-width:100%;border-radius:8px;"><figcaption>Monthly $30K investment 20-year compound growth simulation</figcaption></figure>

VOO, the Vanguard S&P 500 [ETF](/en/study/jepis-03890-dividend-increase-reassessing-income-and-growth-mechan/), tracks all 500 large-cap stocks with an [expense ratio](/en/study/expense-ratio-compounding-003-vs-05-over-30-years/) of 0.03% and minimal annual distributions (1.03% yield). SCHD, Schwab U.S. Dividend Equity ETF, targets dividend-growth stocks at 0.06% expense and generates 3.25% annual income. Performance over the past year shows VOO ahead: +26.8% versus SCHD's +24.2%. Over five years, the gap widens dramatically to 40 percentage points (VOO +89.0%, SCHD +48.4%)[[Yahoo Finance]](https://finance.yahoo.com).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><strong>5-Year Total Return</strong></td>
      <td>+89.0%</td>
      <td>+48.4%</td>
    </tr>
    <tr>
...
<aside class="scenario-box">
  <div class="scenario-header">💡 Scenario: Mike's Monthly Split Between VOO and SCHD</div>

  <div class="scenario-body">
    <p><strong>Setup:</strong> Mike, 35-year-old software engineer in Austin, Texas. Opens a Schwab taxable brokerage account in 2026 and commits to $1,500/month, split evenly: $750 into VOO, $750 into SCHD. No tax-advantaged accounts assumed.</p>
    <p><strong>Projection (ignoring taxes):</strong> At VOO's 26.8% annualized return and SCHD's 24.2%, after 20 years Mike's VOO holdings compound to approximately $1.8M; SCHD to roughly $1.1M. Combined portfolio value: $2.9M before any tax withholding.</p>
    <p><strong>With 15% tax on annual distributions:</strong> Mike owes ~$27 in year-one VOO taxes (small bite). SCHD's $98 year-one tax bill is 3.6× higher. Compounded over 20 years, assuming monthly reinvestment of distributions net of taxes, SCHD's ending value shrinks by roughly 8–12%—a $90K–$130K opportunity cost versus the pre-tax projection. VOO's tax friction barely moves the needle.</p>
    <p><strong>The critical caveat:</strong> Mike's situation assumes a standard taxable account. If he had maxed his Roth IRA ($7,500/year) and placed SCHD there instead, tax drag vanishes—SCHD becomes the ideal choice for tax-deferred compounding due to its high distribution rate. The account type, not the ETF, determines tax efficiency.</p>
  </div>

  <div class="scenario-footnote">Mike is a hypothetical persona created to illustrate the data; he is not a real individual, and these are not real trades.</div>

</aside>

## Where This Analysis Could Fail

The largest blind spot: assuming VOO's 26.8% one-year return is durable. It is not. Market multiples can compress sharply if growth expectations soften—a scenario that would expose VOO's elevated P/E 26.9 to significant downside. SCHD's 18.8 multiple provides more cushion in such an environment. Additionally, if tax policy includes carve-outs for long-term holdings (5+ years) or preferential treatment of qualified dividends, SCHD's tax disadvantage narrows considerably. Finally, should the Federal Reserve enter a prolonged period of rate cuts and deflationary pressures, dividend yields become more valuable relative to growth multiples—exactly the regime where SCHD has historically outperformed VOO. The past five years of growth dominance are not prophecy[[ETF.com]](https://www.etf.com).
