...
draft: false
reviewed: true
description: "VOO 혼조 흐름 데이터 분석: 현재가 $651.26, 1년 +33.9%, P/E 28.1 기준으로 본 장기 ETF 패턴"
keywords: "VOO, VOO 1년 수익률 33.9% 분석, VOO 3년 수익률 78.2% 의미, VOO 5년 수익률 83.2% 해석, VOO 배당수익률 1.09% 평가, VOO P/E 28.1 밸류에이션, VOO 최근 3년 가격 추이, VOO 최대낙폭 차트 해석"
primary_keyword: "VOO"
schema: "Article"
toc: true
cover:
...
<div class="summary-box"><ul><li>현재가: $651.26</li><li>1년 수익률: +33.9%</li><li>3년 수익률: +78.2%</li><li>5년 수익률: +83.2%</li><li>배당수익률: 1.09%</li><li>P/E: 28.1</li><li>에이전트 데이터 분석 결론: HOLD, 혼조 흐름</li></ul></div>

## 핵심 지표 요약

<figure class="chart-figure"><img src="/images/voo-5년-수익률과-밸류에이션-데이터-분석-d87ebd/price-history.png" alt="VOO 최근 3년 가격 차트" loading="lazy" style="max-width:100%;border-radius:8px;"><figcaption><a href="/ko/blog/voo-5년-수익률과-밸류에이션으로-본-흐름/">VOO</a> 최근 3년 가격 차트</figcaption></figure>
...
<table>
<thead>
<tr><th>항목</th><th>VOO</th><th>SPY(동일 지수 추종 peer)</th><th>해석</th></tr>
</thead>
<tbody>
<tr><td>현재가</td><td>$651.26</td><td>제공 데이터 없음</td><td>절대 주가만으로 우열을 가릴 수 없음</td></tr>
<tr><td>1년 수익률</td><td>+33.9%</td><td>제공 데이터 없음</td><td>단기 성과는 강한 편</td></tr>
<tr><td>3년 수익률</td><td>+78.2%</td><td>제공 데이터 없음</td><td>중기 누적 성과가 높음</td></tr>
<tr><td>5년 수익률</td><td>+83.2%</td><td>제공 데이터 없음</td><td>장기 누적 성과가 이어짐</td></tr>
<tr><td>배당수익률</td><td>1.09%</td><td>제공 데이터 없음</td><td>현금흐름보다 가격 상승 비중이 큼</td></tr>
<tr><td>P/E</td><td>28.1</td><td>제공 데이터 없음</td><td>밸류에이션 부담 여부를 함께 봐야 함</td></tr>
</tbody>
</table>
...
<figure class="chart-figure"><img src="/images/voo-5년-수익률과-밸류에이션-데이터-분석-d87ebd/return-bars.png" alt="VOO 기간별 수익률 비교" loading="lazy" style="max-width:100%;border-radius:8px;"><figcaption>VOO 기간별 수익률 비교</figcaption></figure>
...
<figure class="chart-figure"><img src="/images/voo-5년-수익률과-밸류에이션-데이터-분석-d87ebd/drawdown.png" alt="VOO 5년 최대 낙폭 차트" loading="lazy" style="max-width:100%;border-radius:8px;"><figcaption>VOO 5년 최대 낙폭 차트</figcaption></figure>
...
A. 숫자 자체로는 높은 편이다. 다만 3년 +78.2%, 5년 +83.2%와 함께 봐야 최근 1년의 강세가 장기 누적 흐름과 연결되는지 확인할 수 있다.

**Q2. VOO의 P/E 28.1은 무엇을 의미하나?**
A. 시장이 VOO에 반영한 기대가 꽤 높다는 뜻으로 읽을 수 있다. P/E 28.1은 성과가 좋다는 사실과 별개로, 향후 수익률이 같은 속도로 반복될지에 대해 더 조심스럽게 보게 만든다.

**Q3. 배당수익률 1.09%면 배당 매력이 낮은가?**
A. 인컴 관점에서는 낮은 편으로 해석하기 쉽다. VOO는 1.09% 배당보다 가격 상승과 누적 수익률이 더 중요한 구조다.

**Q4. RSI 86.87538234284는 어떤 의미인가?**
A. 단기적으로 매우 강한 흐름이 있었음을 보여준다. 동시에 평균 대비 높은 위치이므로, 과열과 추세 지속 가능성을 같이 보는 게 맞다.

**Q5. 최근 5개 뉴스가 모두 강세였는데 왜 결론이 HOLD인가?**
A. 뉴스는 우호적이지만 표본이 5개로 작고, 기술 수치는 과열을 보여주며, 펀더멘털 데이터는 N/A가 많기 때문이다. 한 방향으로 단정하기보다 혼조로 보는 편이 더 데이터에 가깝다.
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "VOO 5년 수익률과 밸류에이션 데이터 분석",
  "description": "VOO 혼조 흐름 데이터 분석: 현재가 $651.26, 1년 +33.9%, P/E 28.1 기준으로 본 장기 ETF 패턴",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://investiqs.net/ko/blog/voo-5년-수익률과-밸류에이션-데이터-분석-d87ebd/"
  },
  "image": "https://investiqs.net/images/voo-5년-수익률과-밸류에이션-데이터-분석-d87ebd/price-history.png"
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "VOO의 1년 수익률 +33.9%는 높은 편인가?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "숫자 자체로는 높은 편이다. 다만 3년 +78.2%, 5년 +83.2%와 함께 봐야 최근 성과가 장기 흐름과 이어지는지 판단할 수 있다."
      }
    },
    {
      "@type": "Question",
      "name": "VOO의 P/E 28.1은 무엇을 의미하나?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "시장이 VOO에 반영한 기대가 높다는 뜻으로 읽을 수 있다. 성과가 좋다는 사실과 별개로 향후 수익률의 속도는 달라질 수 있다."
      }
    },
    {
      "@type": "Question",
      "name": "배당수익률 1.09%는 어떤 투자자에게 중요한가?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "현금흐름을 중시하는 투자자에게는 낮게 느껴질 수 있다. VOO는 배당보다 가격 상승과 누적 수익률이 더 중요한 구조다."
      }
    },
    {
      "@type": "Question",
      "name": "RSI 86.87538234284는 어떤 신호인가?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "단기 강세가 강했다는 뜻이지만, 과열 가능성도 함께 본다. 상승 추세와 되돌림 가능성을 동시에 체크해야 한다."
      }
    },
    {
      "@type": "Question",
      "name": "최근 5개 뉴스가 모두 강세였는데 왜 결론은 HOLD인가?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "뉴스는 우호적이지만 표본이 작고, 기술 수치는 과열이며, 펀더멘털 데이터는 N/A가 많기 때문이다. 그래서 혼조 흐름으로 해석하는 편이 더 데이터에 맞다."
      }
    }
  ]
}
